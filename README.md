...
### 家族管理
- **登録**: 名前・色・画像（任意）で新しい子を追加
- **編集**: 登録済みの子の名前・色・画像を変更
- **削除**: 不要な子を削除
- **色**: 茶色・白・ピンク・グレー・青・緑・黄・黒・その他
...
- **ボタン文言**: 回転中は「誰が出るかな？」「ゆちゅきと寝たいなぁ」「楽しみ！！」などをランダム表示。結果表示中は「おめでとう！」「今日はパーティー！」「お外連れてって！」をランダム表示
- **結果表示中**: 3秒間はボタンが無効になり、自動で円盤に戻るまで待つ

### 当選履歴・リセット
- **当選履歴**: その回の当選者を一覧表示（登録色・画像付き）
